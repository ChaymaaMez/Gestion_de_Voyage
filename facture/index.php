...
if(isset($_POST['benrg1'])&&!empty($nom)&&!empty($contact)){
...
<body>
	...
	<fieldset >
      ...
      <tr><td></td><td><input type="submit" name="benrg1" value="ENREGISTRER" class="bouton"></td></tr>
...
<h2>Formulaire d'enregistrement des factures</h2>
	...
	<option  value="<?php echo $type; ?>"><?php echo $type; ?></option>
        ...
        <option  value="CHAMBRE&RESTAURANT">CHAMBRE&RESTAURANT</option>
        <option  value="CHAMBRE&TAXI">CHAMBRE&TAXI</option>
        <option  value="CHAMBRE&VOITURE">CHAMBRE&VOITURE</option>
        <option  value="CHAMBRE&VOL&LOCATION">CHAMBRE&VOL&LOCATION</option>
     </select></td></tr>
