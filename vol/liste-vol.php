...
echo"<tr>";
    ...
    echo"<th>"."flying_from";echo"</th>";
    echo"<th>"."flying_to";echo"</th>";
    echo"<th>"."departing";echo"</th>";
    echo"<th>"."arriving";echo"</th>";
    echo"<th>"."comfort";echo"</th>";
    echo"<th>"."adults";echo"</th>";
    echo"<th>"."children";echo"</th>";
    echo"<th>"."class";echo"</th>";
